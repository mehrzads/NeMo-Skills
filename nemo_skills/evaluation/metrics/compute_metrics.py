...
class ComputeMetrics:
    def __init__(
        ...
        self.calculators = {}
        self.extra_metrics_arguments = extra_metrics_arguments

    def get_metrics_calculator(self):
        metrics_calculator = get_metrics(self.metric_type, extra_arguments=self.extra_metrics_arguments)
