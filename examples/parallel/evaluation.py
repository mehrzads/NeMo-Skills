...
def main( code_input_files: List[str],  cluster: str, eval_type: str):            
    ...
    for code_input_file in code_input_files:
        ...
        eval_command = (
            f"sleep 1200 && python -m nemo_skills.evaluation.evaluate_results "
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_type", type=str, default="ioi24", 
                        help="Type of evaluation to run (e.g., ioi25, ioi24). Default: ioi24")
