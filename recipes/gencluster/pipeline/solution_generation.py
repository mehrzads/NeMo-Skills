...
eval(
    ...
    output_dir="/workspace/gpt-oss-120b/generation/run_3_icpc25_1000/",
    metrics_kwargs='{"cluster_folder": "/workspace/gpt-oss-120b/generation/run_3_icpc25_1000/clusters/"}',
    split="test",
    time_min="04:00:00",
)
